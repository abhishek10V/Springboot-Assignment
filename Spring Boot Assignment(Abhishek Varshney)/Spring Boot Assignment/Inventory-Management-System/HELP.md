...
* The original package name 'com.example.Spring Boot Assignment' is invalid and this project uses 'com.example.Spring.Boot.Assignment' instead.
...
* [Spring Data Neo4j](https://docs.spring.io/spring-boot/3.3.8/reference/data/nosql.html#data.nosql.neo4j)
